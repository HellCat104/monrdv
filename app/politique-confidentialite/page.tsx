          ...
          <div className="space-y-10 mt-10">
            ...
            <Section id="responsable" number="1" title="Responsable du traitement des données">
              <div className="bg-gray-50 rounded-xl p-5 text-sm text-gray-700 space-y-1.5">
                ...
                <p>
                  <strong>Email :</strong>{' '}
                  <a href="mailto:privacy@monrdv.ma" className="text-green-700 hover:underline">
                    privacy@monrdv.ma
                  </a>
                </p>
                <p>
                  <strong>Contact général :</strong>{' '}
                  <a href="mailto:contact@monrdv.ma" className="text-green-700 hover:underline">
                    contact@monrdv.ma
                  </a>
                </p>
            ...
            <Section id="engagement" number="2" title="Engagement CNDP et loi 09-08">
              <p className="text-gray-600 leading-relaxed">
                Conformément à la loi n° 09-08, MonRDV a effectué les déclarations requises auprès de la
              ...
              <div className="bg-gray-50 rounded-xl p-4 text-sm text-gray-700">
                <p className="font-semibold mb-1">Référence de déclaration CNDP :</p>
